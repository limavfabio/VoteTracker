...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference("Candidate.count") do
      post candidates_url, params: { candidate: { name: @candidate.name, office: @candidate.office, party_id: @candidate.party_id } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { name: @candidate.name, office: @candidate.office, party_id: @candidate.party_id } }
